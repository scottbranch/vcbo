  ...
  return (
    <div className="container mx-auto services-page">
      ...
      <div className="grid grid-cols-4 mt-60 gap-x-8">
        ...
        <ScrollAnimate className="col-start-3 col-span-2 w-full">
          <img
        ...
        <div className="col-start-4 col-span-1">
          <ScrollAnimate>
            ...
            <p>
              ...
              committees, and stakeholders to encapsulate and execute the vision
              of each intricate planning project.
            </p>
